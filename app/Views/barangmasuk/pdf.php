		...
		<table class="items">
			<thead>
				<tr>
					...
					<th class="">Jumlah</th>
					<th class="left">Tanggal Pembelian</th>
				</tr>
			</thead>
			<tbody>
				<?php $i = 1; ?>
				...
				?>
					<tr>
						...
						<td class="left">Rp <?php echo format_rupiah($data->harga); ?></td>
						<td class=""><?php echo $data->jumlah; ?></td>
						<td class="left"><?php echo get_formatted_date($data->tgl_pembelian); ?></td>
					</tr>
				<?php endforeach;
				?>
			</tbody>
