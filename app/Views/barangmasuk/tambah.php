    ...
    <div class="header-body">
      <div class="row align-items-center py-4">
        <div class="col-lg-6 col-7">
          <h6 class="h2 text-white d-inline-block mb-0">Tambah Barang Masuk</h6>
        </div>
...
<div class="container-fluid mt--6">
  <?php echo form_open_multipart('barangmasuk/add_simpan'); ?>
      ...
      <div class="card-wrapper">
        <div class="card">
          <div class="card-header">
            <h3 class="mb-0">Tambah Barang Masuk</h3>
            <?php if ($flash) : ?>
          ...
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <input type="number" name="harga" value="<?php echo set_value('harga'); ?>" class="form-control" id="harga" placeholder="Masukkan Harga">
            ...
            <div class="form-group">
              ...
              <input type="number" name="jumlah" value="<?php echo set_value('jumlah'); ?>" class="form-control" id="jumlah" placeholder="Masukkan Jumlah">
              <div class="form-error text-danger font-weight-bold"> <?= $validation->getError('jumlah'); ?></div>
            </div>
            <div class="form-group">
              <label class="form-control-label" for="tgl_pembelian">Tanggal Pembelian:</label>
              <input type="date" name="tgl_pembelian" value="<?php echo set_value('tgl_pembelian'); ?>" class="form-control" id="tgl_pembelian">
