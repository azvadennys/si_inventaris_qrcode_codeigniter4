    ...
    <div class="header-body">
      <div class="row align-items-center py-4">
        <div class="col-lg-6 col-7">
          <h6 class="h2 text-white d-inline-block mb-0">Edit Ruangan</h6>
        </div>
        <div class="col-lg-6 col-5 text-right">
          <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
              ...
              <li class="breadcrumb-item"><a href="<?php echo base_url('ruangan/view/' . $ruangan->id_ruangan); ?>"><?php echo $ruangan->nama_ruangan; ?></a></li>
...
<div class="container-fluid mt--6">
  <?php echo form_open_multipart('ruangan/edit_ruangan'); ?>
  ...
  <div class="row">
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <input type="text" name="nama_ruangan" value="<?php echo set_value('nama_ruangan', $ruangan->nama_ruangan); ?>" class="form-control" id="nama_ruangan">
    ...
    <div class="col-md-4">
      <div class="card">
        ...
        <div class="card-body">
          <?php if ($ruangan->foto != NULL) : ?>
            <div class="tab-content" id="pills-tabContent">
              <div class="tab-pane fade show active" id="pills-current" role="tabpanel" aria-labelledby="pills-home-tab">
                <div class="text-center">
                  <img alt="<?php echo $ruangan->nama_ruangan; ?>" src="<?php echo base_url('assets/uploads/ruangan/' . $ruangan->foto); ?>" class="img img-fluid rounded">
                </div>
              </div>
  ...
  <script>
    $('.deletePictureBtn').click(function(e) {
      ...
      $.ajax({
        method: 'POST',
        url: '<?php echo base_url('ruangan/product_api?action=delete_image'); ?>',
        data: {
          id: <?php echo $ruangan->id_ruangan; ?>
        },
        context: this,
