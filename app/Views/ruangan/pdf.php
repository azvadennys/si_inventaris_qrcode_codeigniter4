		...
		<table class="items">
			<thead>
				<tr>
					...
					<th class="left">Nama Ruangan</th>
					<th class="left">Lokasi Gedung</th>
			...
			<tbody>
				...
				?>
					<tr>
						<td><?php echo $i++; ?></td>
						<td class="left"><?php echo $data->nama_ruangan; ?></td>
						<td class="left"><?php echo ruangan_data($data->id_ruangan); ?></td>
						<td class=""><?php echo count_barang_in_ruangan($data->id_ruangan); ?></td>
					</tr>
				<?php endforeach;
				?>
			</tbody>
